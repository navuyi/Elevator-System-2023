...
describe("Tests taking people in", () => {
    ...
    test("Should not take the person due to limit", () => {
        const elevator : I_ELEVATOR = {
            currentFloor: 5,
            direction: "up",
    ...
    test("Should not take the person because different floors", () => {
        const elevator : I_ELEVATOR = {
            currentFloor: 5,
            direction: "up",
    ...
    test("Should not take the person because different direction", () => {
        const elevator : I_ELEVATOR = {
            currentFloor: 5,
            direction: "up",
    ...
    test("Should take all people from the floor", () => {
        const elevator : I_ELEVATOR = {
            currentFloor: 5,
            direction: "up",
